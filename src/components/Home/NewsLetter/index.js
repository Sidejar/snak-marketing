...
const NewsLetter = () => {
  return (
    <div className="rounded-[20px] py-16 px-6 bg-bgPrimary flex flex-col items-center gap-8 mt-0 md:mt-[100px] lg:mt-[128px]">
      <div>
      ...
      <div className="flex flex-col items-center gap-4 md:max-w-[343px] w-full">
        ...
        />
        <Button
          className="!py-[13px] !rounded-[14px] px-[27px] md:max-w-[128px] w-full flex justify-center"
          cta={() => {}}
          type=""
          bg
          disabled=""
